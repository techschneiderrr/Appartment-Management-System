...
<body>
  ...
  <div class="content container" style="text-align:center;">
    ...
    <form action="" method="post" class="form-add-owner">
      ...
      <div class="row mb-3">
        ...
        <div class="col-sm-9">
          <input type="number" class="form-control" onkeypress="return /[0-9]/i.test(event.key)" id="phn" name="phn" <?php
  ...
  <footer class="footer footer-distributed sticky-bottom">
    ...
    <div class="footer-left">
      ...
      <p>Copyright © 2021 ManVeer Group - Apartment Management System.</p>
    </div>
